...
const Cart = () => {
  ...
  return (
   ...
   <img className="w-full h-80 object-cover" 
      src="https://images.pexels.com/photos/7005283/pexels-photo-7005283.jpeg?auto=compress&cs=tinysrgb&w=600" alt="cartImg" />
       <div className="max-w-screen-xl mx-auto py-20 flex">
        ...
        <div className="w-1/3 bg-[#fafafa] py-6 px-4">
          <div className="flex flex-col gap-6 border-b-[1px] border-b-gray-400 pb-6">
            ...
            <p className="flex items-start gap-4 text-base">Shipping: {" "}
            <span>Unit 1, 44A Boadle Road, Bundoora, Melbourne, VIC 3083</span>
            </p>
          </div>
