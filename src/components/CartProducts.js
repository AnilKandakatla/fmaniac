...
import { decrementQuantity, deleteItem, incrementQuantity, resetCart } from "../redux/fashionSlice"
...
const CartProducts = () => {
  ...
  return (
    <div className="w-2/3 pr-10">
        ...
        className="bg-red-500 text-white mt-8 ml-7 py-1 px-6 hover:bg-red-800 duration-300">Reset cart</button>
        <Link to="/">
